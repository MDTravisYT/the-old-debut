...
; Created on Fri Mar 13 2020, 21:29:38
; -------------------------------------------------------
...
MusContinueScreen_Header:
	...
	smpsHeaderPSG	MusContinueScreen_PSG1,	$dc, $2, $0
	smpsHeaderPSG	MusContinueScreen_PSG2,	$dc, $2, $0
...
MusContinueScreen_Voices:
	...
	dc.b	$2,$f,$f,$f,$1f,$18,$24,$22,$81	; Voice 0 (Voice 0 ripped from Mus90 - Continue Screen.bin)
