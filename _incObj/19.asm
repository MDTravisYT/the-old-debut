...
Obj19:
		...
		rts	
; ===========================================================================
Obj19_Index:	dc.w Obj19_Main-Obj19_Index
		dc.w Obj19_Touch-Obj19_Index
		dc.w Obj19_Spin-Obj19_Index
		dc.w Obj19_SonicRun-Obj19_Index
		dc.w Obj19_Exit-Obj19_Index

spintime:	equ $30		; time for Obj19post to spin
sparkletime:	equ $32		; time between sparkles
sparkle_id:	equ $34		; counter to keep track of sparkles
; ===========================================================================

Obj19_Main:	; Routine 0
...
Obj19_Touch:	; Routine 2
		move.w	(v_player+obX).w,d0
		sub.w	obX(a0),d0
		bcs.s	@notouch
		cmpi.w	#$20,d0		; is Sonic within $20 pixels of	the Obj19post?
		bcc.s	@notouch	; if not, branch
		music	sfx_signpost,0,0,0	; play Obj19post sound
...
Obj19_Spin:	; Routine 4
	...
	@chksparkle:
		...
		lea	Obj19_SparkPos(pc,d0.w),a2 ; load sparkle position data
		bsr.w	FindFreeObj
		bne.s	@fail
	...
	@fail:
		rts	
; ===========================================================================
Obj19_SparkPos:	dc.b -$18,-$10		; x-position, y-position
		dc.b	8,   8
		dc.b -$10,   0
		dc.b  $18,  -8
		dc.b	0,  -8
...
Obj19_GotThroughAct:
	...
	@hastimebonus:
		add.w	d0,d0
		move.w	obj19_timebonuses(pc,d0.w),(v_timebonus).w ; set time bonus
...
; ===========================================================================
obj19_timebonuses:	dc.w 5000, 5000, 1000, 500, 400, 400, 300, 300,	200, 200
		dc.w 200, 200, 100, 100, 100, 100, 50, 50, 50, 50, 0
; ===========================================================================

Obj19_Exit:	; Routine 8
		rts	
